...
public class WritingFile implements IWritingFile {
    ...
    public  int writingFile(String filepathWriting, List<String> sortedList, List<String>myList) throws IOException { /** writing file from an ArrayList our aim was to write each single ArrayList element onto our new file so we decided to build a function and counting occurrences*/
